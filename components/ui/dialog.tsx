...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left min-w-0 overflow-visible",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-fluid-lg font-semibold leading-none tracking-tight min-w-0 overflow-visible",
      className
    )}
    {...props}
  />
